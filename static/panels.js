...
// ── Bots panel (palier B / B2-B4) — fork ───────────────────────────
// The panel itself lives in static/bots_panel.js (fork-only file, loaded
// before this one) so upstream releases do not conflict over it. What stays
// here are the integration points into upstream code: the loadBotsPanel /
// _botsPanelVisible calls in switchPanel, and the opts.keepSidebarPanel
// branch that keeps the Bots list beside an open conversation.
