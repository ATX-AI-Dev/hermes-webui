...
(function () {
  var FORK = {
    en: {
      ...
      bot_pane_pin: 'Pin beside',
      bot_pane_close: 'Close pane',
      bot_pane_send: 'Send',
      bot_pane_promote: 'Switch here',
      bot_pane_promote_hint: 'Make this bot the main conversation (and pin the current one instead)',
      bot_pane_placeholder: 'Reply to this bot…',
      bot_pane_same_bot: 'This bot is already the main conversation.',
      bots_channel_audit: 'Channels',
      bots_channel_auditing: 'Scanning the inter-bot threads…',
      bots_channel_clean: 'No off-spec exchange in the last 7 days.',
      bots_channel_offspec: 'off-spec',
      bots_channel_offspec_hint: 'This channel is not in the authorised map (detection only — nothing was blocked)',
      bots_channel_offspec_count: '{n} off-spec exchange(s) over {d} days',
      bots_channel_map_broken: 'Channel map inconsistent:',
    ...
    fr: {
      ...
      bot_pane_pin: 'Épingler à côté',
      bot_pane_close: 'Fermer le panneau',
      bot_pane_send: 'Envoyer',
      bot_pane_promote: 'Basculer ici',
      bot_pane_promote_hint: 'Faire de ce bot la conversation principale (et épingler l’actuelle à la place)',
      bot_pane_placeholder: 'Répondre à ce bot…',
      bot_pane_same_bot: 'Ce bot est déjà la conversation principale.',
      bots_channel_audit: 'Canaux',
      bots_channel_auditing: 'Analyse des fils inter-bots…',
      bots_channel_clean: 'Aucun échange hors spec sur les 7 derniers jours.',
      bots_channel_offspec: 'hors spec',
      bots_channel_offspec_hint: 'Ce canal n’est pas dans la carte autorisée (détection seule — rien n’a été bloqué)',
      bots_channel_offspec_count: '{n} échange(s) hors spec sur {d} jours',
      bots_channel_map_broken: 'Carte des canaux incohérente :',
